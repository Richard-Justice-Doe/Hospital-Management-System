    ...
    patients: [
      {
        ...
        occupation: 'Trader',
        nextOfKin: { name: 'Kofi Owusu', relationship: 'Spouse', phone: '024 111 0102', address: 'House 12, Boundary Road' },
        nhisStatus: 'ACTIVE',
        nhisExpires: '2027-04-15',
        preferredPayment: 'NHIS',
        registeredClinic: 'MATERNITY',
        emergencyContact: { name: 'Kofi Owusu', relationship: 'Spouse', phone: '024 111 0102' },
        bloodGroup: 'O+',
    ...
    copayers: [
      {
        ...
        insuranceType: 'GOVERNMENT',
        insuranceProvider: 'NHIS',
        insuranceNumber: 'NHIS-OWU-4412',
        ghanaCardNo: 'GHA-441255678-2',
        hinNumber: 'HIN-OWU-4412',
        createdAt: minutesAgo(180),
      },
      {
        id: 'pay-lisa-parent',
      ...
      },
      {
        ...
        insuranceType: 'GOVERNMENT',
        insuranceProvider: 'NHIS',
        insuranceNumber: 'NHIS-PAT-0105',
        ghanaCardNo: 'GHA-554010567-1',
        createdAt: minutesAgo(40),
      },
    ],
    visits: [
      ...
      },
      {
        ...
        patientId: 'pat-omar',
        clinic: 'GENERAL',
        reason: 'Incision and drainage of abscess',
        stage: 'AWAITING_SERVICES',
        checkedInAt: minutesAgo(80),
        checkedInBy: 'staff-reception',
        vitalsDoneAt: minutesAgo(70),
        withDoctorAt: minutesAgo(55),
        diagnosis: 'Superficial abscess — I&D in theatre',
        notes: 'Doctor sent to theatre for incision and drainage.',
        disposition: 'DISCHARGED',
        vitals: {
          systolicBp: 128,
          diastolicBp: 82,
        ...
        orders: [
          { id: 'ord-ot-reg', serviceId: 'reg-review', name: 'Returning patient / folder review', department: 'RECORDS', priceGhs: 5, status: 'DONE' },
          { id: 'ord-ot-opd', serviceId: 'opd-general', name: 'General OPD consultation', department: 'CONSULTATION', priceGhs: 50, status: 'DONE' },
          { id: 'ord-ot-minor', serviceId: 'th-minor', name: 'Minor theatre procedure', department: 'THEATRE', priceGhs: 200, status: 'ORDERED' },
        ],
      },
    ],
  });
